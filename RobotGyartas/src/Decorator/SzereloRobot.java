 ...
 * @author Dani
 */
public class SzereloRobot extends Robot {
    private Memoria memoria;
    private SzereloAlaplap alaplap;
    ...
    public SzereloRobot(Memoria memoria,  FoAlapTipus alaplaptipus, Camera camera, SoftwareType software, Teljesitmeny teljesitmeny, Proci proci, RobotKulso kulso) 
        ...
        this.memoria = memoria;
         ...
         if(this.alaplap.getFoAlapTipus().Szerelo != alaplap.getFoAlapTipus()){
